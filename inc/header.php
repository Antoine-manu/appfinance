            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link <?= active()=='backoffice' ? 'active' : '' ?>" href="backoffice.php?id=<?=$id?>">Tableau
                            de bord <i class="fas fa-wallet "></i></a>
                        <a class="nav-link <?= active()=='adduser' ? 'active' : '' ?>" href="adduser.php?id=<?=$id?>">Ajouter un
                            utilisateur <i class="fas fa-user-plus"></i></a>
                        <a class="nav-link <?= active()=='addrevenue' ? 'active' : '' ?>" href="addrevenue.php?id=<?=$id?>">Déclarer
                            un revenu <i class="fas fa-piggy-bank"></i></a>
                        <a class="nav-link <?= active()=='adddepense' ? 'active' : '' ?>" href="adddepense.php?id=<?=$id?>">Déclarer
                            une depense <i class="fas fa-donate"></i></a>
                        <a class="nav-link <?= active()=='userlist' ? 'active' : '' ?>" href="userlist.php?id=<?=$id?>">Voir les
